...
$Script = "https://aimlp.blob.core.windows.net/egnyte/Mount-Drives.ps1"
$File = "C:\Deploy\Mount-Drives.ps1"
...
function Get-Script {
    <#
    .Synopsis
    Downloads the mounting script.
    .Parameter URL
    Input the URL to the mounting script. Must be publicly accessible.
    #>
    [CmdletBinding(DefaultParameterSetName = "URL")]
    [OutputType([String], ParameterSetName = "URL")]
    param (
    ...
    process {
        try {
            ...
            $outpath = "C:\Deploy\Mount-Drives.ps1"
